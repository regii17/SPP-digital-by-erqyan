        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="siswa.php"></a>Siswa</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
if (isset($_GET['pesan'])) {
  if ($_GET['pesan'] == "berhasilhapus") {
    ...
    <a href="siswa.php"><button type="button" class="close">×</button></a>
                    ...
                    <td style="text-align:center;">
                      ...
                      <td><a class="btn btn-info btn-sm" href="?hal=siswa&id=<?php echo $x['nisn']; ?>&act=edit">
                        ...
                        <a class="btn btn-danger btn-sm"
                          href="proses.php?id=<?php echo $x['nisn']; ?>&aksi=hapus&table=siswa&kolom=nisn"><i
