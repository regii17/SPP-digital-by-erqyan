        ...
        <form class="form-horizontal" action="proses.php" method="post">
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail3" value="P-<?php echo $d['id_pembayaran']; ?>"
                  disabled>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="namapetugas" class="form-control"
                  value="<?php
                  foreach ($db->detail_data($d['id_petugas'], "petugas", "id_petugas") as $x) {
                    echo $x['nama_petugas'] . " - " . $x['id_petugas'];
                  } ?>" disabled>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="tgl" class="form-control" value="<?php echo $d['tgl_bayar']; ?>">
              </div>
            </div>
