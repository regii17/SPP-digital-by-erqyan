        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="spp.php"></a>SPP</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
if (isset($_GET['pesan'])) {
  if ($_GET['pesan'] == "berhasilhapus") {
    ...
    <a href="spp.php"><button type="button" class="close">×</button></a>
                ...
                <table>
                  ...
                  foreach ($db->tampil_data("spp", "id_spp") as $x) {
                    ...
                    <td style="text-align:center;">
                      ...
                      <td><a class="btn btn-info btn-sm" href="?hal=spp&id=<?php echo $x['id_spp']; ?>&act=edit">
                          <i class="fas fa-pencil-alt"></i>Edit</a>
                        <a class="btn btn-danger btn-sm"
                          href="proses.php?id=<?php echo $x['id_spp']; ?>&aksi=hapus&table=spp&kolom=id_spp">
