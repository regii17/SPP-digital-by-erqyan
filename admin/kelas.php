        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="kelas.php"></a>Kelas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <table>
                  ...
                  foreach ($db->tampil_data("kelas", "id_kelas") as $x) {
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $x['kompetensi_keahlian']; ?>
                      </td>
                      <td><a class="btn btn-info btn-sm" href="?hal=kelas&id=<?php echo $x['id_kelas']; ?>&act=edit">
                          <i class="fas fa-pencil-alt"></i>Edit</a>
                        <a class="btn btn-danger btn-sm"
                          href="proses.php?id=<?php echo $x['id_kelas']; ?>&aksi=hapus&table=kelas&kolom=id_kelas" ><i
