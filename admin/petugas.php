...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/logo.png" alt="Nekas Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="petugas.php"></a>Petugas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
if (isset($_GET['pesan'])) {
  if ($_GET['pesan'] == "berhasilhapus") {
    ...
    <a href="petugas.php"><button type="button" class="close">×</button></a>
    ...
    echo '<div class="alert alert-warning alert-dismissible">
        <a href="petugas"><button type="button" class="close">×</button></a>
          <h5><i class="far fa-check-circle"></i> BEHASIL</h5>
...
if(isset($_GET['hal'])&& isset($_GET['act'])){
	...
	include $op.".php";
      ...
      <div style="margin-left:8px; margin-bottom:-10px;" class="col-12"> 
  ...
  <td style="text-align:center;"><?php echo $no++; ?></td>
    ...
    <td><?php echo $x['level']; ?></td>
		<td><a class="btn btn-info btn-sm" href="?hal=petugas&id=<?php echo $x['id_petugas']; ?>&act=edit">
